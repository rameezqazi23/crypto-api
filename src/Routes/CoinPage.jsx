...
const CoinPage = () => {
  ...
  useEffect(() => {
    axios.get(url).then((response) => {
      ...
      console.log("Coin Page data==>", response.data)
      ...
      <div className='grid md:grid-cols-2 gap-8'>
        <div>
          ...
          <div className='flex justify-between py-4'>
            ...
            <div>
              <p className='text-gray-600 text-sm'>Market Volume 24h</p>
        ...
        <div>
          ...
          <div className='flex justify-between py-4'>
            <div>
              <p className='text-gray-600 text-sm'>Market Rank</p>
              {coin?.market_cap_rank}
            </div>

            <div>
              <p className='text-gray-600 text-sm'>Hashing Algorithm</p>
          ...
          <div className='flex justify-between py-4'>
            <div>
              <p className='text-gray-600 text-sm'>Price Change 24h</p>
              {coin?.market_data ?
            ...
            <div>
              <p className='text-gray-600 text-sm'>Price Change 7d</p>
              {coin?.market_data ?
            ...
            <div>
              <p className='text-gray-600 text-sm'>Price Change 14d</p>
              {coin?.market_data ?
